...
$(document).ready(function() {
    ...
    $('.accordion').on('show hide', function(e){
        $(e.target).siblings('.accordion-heading').find('.accordion-toggle i').toggleClass('icon-left-circle icon-down-circle', 200);
    });
...
(function() {
    ...
    $mainMenu.on('mouseenter', 'li', function() {
        ...
        if($nthis.parent().is($(':gt(1)', $mainMenu))){
            ...
            $nthis.children('ul').css('right', 130).css('opacity', 0).css('display', 'none');
...
function initialize( id ) {
    ...
    var map ;
    var myLatlng; 
    var address = 'Motahari Square, Semnan, Iran';
    var PlaceName = 'Motahari Square';
    var myOptions = {
        zoom: parseInt(14),
